...
이 글은 의견보다 **원문 정보(약 90%)**를 중심으로 정리하고,
마지막에만 내 해석(약 10%)을 붙인다.

---

## 1) 공식 발표에서 확인되는 사실 (원문 중심)
...
## 3) C++ 실무에 대입하면 바로 보이는 적용 지점 (사실 기반 해석 최소)
...
머메이드 대신 **원문 기사 이미지**를 쓰는 방향으로 전환한다.

- TechCrunch 본문에 `Image Credits: Anthropic` 명시 이미지 존재
- CNBC 기사에도 관련 현장 사진(Reuters credit) 포함

> 블로그 반영 시 권장: 원문 페이지 스크린샷/대표 이미지(출처·저작권 표기) 사용
> - 캡션 예시: `Source: TechCrunch (2026-02-05), Image Credits: Anthropic`
